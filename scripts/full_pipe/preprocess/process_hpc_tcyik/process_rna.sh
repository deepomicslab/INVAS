...
#SBATCH --job-name=tc-yik-rna
#SBATCH --output=log.yikrna.log

threads=128

eval "$(conda shell.bash hook)"

outdir=/scratch/project/cs_shuaicli/wxd/virus/WuHan_TongJi_SCCC/TC-YIK/RNA/rna_out
...
# samtools fastq \
#     -0 $sample/${sample}.hisat2.ori.unpaired.fastq \
#     -1 $sample/${sample}.hisat2.ori.1.fastq \
#     -2 $sample/${sample}.hisat2.ori.2.fastq \
#     -s $sample/${sample}.hisat2.ori.single.fastq \
#     -N $sample/${sample}.hisat2.sortn.bam
fq1=/scratch/project/cs_shuaicli/wxd/virus/WuHan_TongJi_SCCC/TC-YIK/RNA/170519_X515_FCH2FMCCCXY_L1_WHHUMghmEAAARAAPEI-205_1.fq.gz
fq2=/scratch/project/cs_shuaicli/wxd/virus/WuHan_TongJi_SCCC/TC-YIK/RNA/170519_X515_FCH2FMCCCXY_L1_WHHUMghmEAAARAAPEI-205_2.fq.gz
