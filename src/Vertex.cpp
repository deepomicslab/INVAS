...
Vertex::Vertex(std::string mId, std::string aChrom, int aStart, int aEnd,float aAbouandance, float aCredibility, int aCopyNum, int idx, int copy_idx) {
    ...
    this->idx = idx;
//    create weight
    weight = new Weight(aAbouandance);
    weight->setCopyNum(aCopyNum);
    weight->setCapacity(depth);
...
Vertex::Vertex(std::string mId, std::string aChrom, int aStart, int aEnd,float aAbouandance, float aCredibility, int aCopyNum, int idx, int copy_idx, float cov) {
    this->copy_idx = copy_idx;
    this->Id = mId;
    this->orphan = true;
    this->chrom = aChrom;
    ...
    this->idx = idx;
//    create weight
    weight = new Weight(cov);
    weight->setCopyNum(aCopyNum);
    weight->setCapacity(aAbouandance);
    this->cov = cov;
    this->aboundance = aAbouandance;
...
bool Vertex::getIsGSource(){
    return this->isGSource;
}

void Vertex::setIsGSource(bool isGSource){
    this->isGSource = isGSource;
}

bool Vertex::getIsGSink(){
    return this->isGSink;
}

void Vertex::setIsGSink(bool isGSink){
    this->isGSink = isGSink;
}
bool Vertex::getIsStart(){
    return this->isStart;
}

void Vertex::setIsStart(bool isStart){
    this->isStart = isStart;
}

bool Vertex::getIsEnd(){
    return this->isEnd;
}

void Vertex::setIsEnd(bool isEnd){
    this->isEnd = isEnd;
}

bool Vertex::getIsConStart(){
    return this->isConStart;
}

void Vertex::setIsConStart(bool isConStart){
    this->isConStart = isConStart;
}

bool Vertex::getIsConEnd(){
    return this->isConEnd;
}

void Vertex::setIsConEnd(bool isConEnd){
    this->isConEnd = isConEnd;
}

void Vertex::setRev(float rev){
    this->rev = rev;
}
...
float Vertex::getFlow(){
    return this->flow;
}

void Vertex::setFlow(float flow){
    this->flow = flow;
}

void Vertex::setSignal(std::string signal){
    this->signal = signal;
}

std::string Vertex::getSignal(){
    return this->signal;
}
