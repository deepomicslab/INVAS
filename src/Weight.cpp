...
float Weight::getFlow() { return flow; }

void Weight::setFlow(float aFlow) { flow = aFlow; }

void Weight::setCapacity(float capacity) { this->capacity = capacity; }

float Weight::getCapacity() { return capacity; }

void Weight::setConCoverage(float conCoverage) { this->conCoverage = conCoverage; }
float Weight::getConCoverage() { return conCoverage; }
