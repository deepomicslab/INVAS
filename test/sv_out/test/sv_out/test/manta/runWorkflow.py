#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/data6/wangxuedong/invas_nc/invas_data_prep/bin/configManta.py --bam /data6/wangxuedong/invas_nc/INVAS/test/demo/DNA/inv_wgs.hg19.bam --referenceFasta /data6/wangxuedong/invas_nc/wgs_ref/hg19.fa --runDir sv_out/test/manta'
#
...
sys.path.append(r'/data6/wangxuedong/invas_nc/invas_data_prep/lib/python')
...
main(r"/data6/wangxuedong/invas_nc/INVAS/test/sv_out/test/sv_out/test/manta/runWorkflow.py.config.pickle","manta",MantaWorkflow)
